...
<section class="content">
  ...
  <div class="box-body pad table-responsive">
                <table class="table table-bordered text-center">
                  ...
                  <tr>
                    <td>
                      <button type="button" class="btn btn-block btn-danger btn-flat">Tambah mahasiswa</button>
                    </td>
                    <td>
                      <button type="button" class="btn btn-block btn-danger btn-flat">Hapus mahasiswa</button>
                    </td>
                  </tr>
                </table>
              </div>
